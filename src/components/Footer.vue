    ...
    <div class="container">
      <div class="footer-content">
        <div class="footer-section">
          <h3 class="footer-title">Mycelium SDK</h3>
          <p class="footer-description">
            Мощный инструмент для современной разработки с TypeScript, Vue.js и Vite.
          </p>
        ...
        <div class="footer-section">
          <h4 class="footer-subtitle">Продукт</h4>
          <ul class="footer-links">
            <li><a href="#" class="footer-link">Функции</a></li>
        ...
        <div class="footer-section">
          ...
          <ul class="footer-links">
            ...
            <li><a href="#" class="footer-link">Сообщество</a></li>
            <li><a href="#" class="footer-link">Статус</a></li>
            <li><a href="#" class="footer-link">Обратная связь</a></li>
          </ul>
        </div>
      </div>
      ...
      <div class="footer-bottom">
        <p class="footer-copyright">
          © 2024 Mycelium SDK. Все права защищены.
        </p>
...
// Компонент Footer не требует логики
</script>
